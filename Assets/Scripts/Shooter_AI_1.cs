...
/* @author: Kevin Graves
 * About half the code is this file was copied from the tutorial script to mimic
 * character controllers functionality with simple AI isntead of user inputs
 */
